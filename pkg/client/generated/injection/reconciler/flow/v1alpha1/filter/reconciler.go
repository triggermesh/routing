...
type reconcilerImpl struct {
	...
	Lister flowv1alpha1.FilterLister
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client internalclientset.Interface, lister flowv1alpha1.FilterLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) updateStatus(ctx context.Context, existing *v1alpha1.Filter, desired *v1alpha1.Filter) error {
	...
	return reconciler.RetryUpdateConflicts(func(attempts int) (err error) {
		...
		if attempts > 0 {
			...
			getter := r.Client.FlowV1alpha1().Filters(desired.Namespace)
		...
		updater := r.Client.FlowV1alpha1().Filters(existing.Namespace)
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.Filter) (*v1alpha1.Filter, error) {
	...
	patcher := r.Client.FlowV1alpha1().Filters(resource.Namespace)
