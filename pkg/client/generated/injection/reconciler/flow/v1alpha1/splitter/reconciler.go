...
import (
	...
	v1alpha1 "github.com/triggermesh/routing/pkg/apis/flow/v1alpha1"
	internalclientset "github.com/triggermesh/routing/pkg/client/generated/clientset/internalclientset"
	flowv1alpha1 "github.com/triggermesh/routing/pkg/client/generated/listers/flow/v1alpha1"
	zap "go.uber.org/zap"
...
type reconcilerImpl struct {
	...
	Lister flowv1alpha1.SplitterLister
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client internalclientset.Interface, lister flowv1alpha1.SplitterLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) updateStatus(ctx context.Context, existing *v1alpha1.Splitter, desired *v1alpha1.Splitter) error {
	...
	return reconciler.RetryUpdateConflicts(func(attempts int) (err error) {
		...
		if attempts > 0 {
			...
			getter := r.Client.FlowV1alpha1().Splitters(desired.Namespace)
		...
		updater := r.Client.FlowV1alpha1().Splitters(existing.Namespace)
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.Splitter) (*v1alpha1.Splitter, error) {
	...
	patcher := r.Client.FlowV1alpha1().Splitters(resource.Namespace)
